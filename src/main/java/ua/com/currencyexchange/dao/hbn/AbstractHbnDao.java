...
public abstract class AbstractHbnDao<T extends Object> implements Dao<T> {
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#create(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#get(java.io.Serializable)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#load(java.io.Serializable)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#update(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#delete(java.lang.Object)
	 */
	@Override
	public void delete(T t) { getSession().delete(t); }
	
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#deleteById(java.io.Serializable)
	 */
	@Override
	public void deleteById(Serializable id) { delete(load(id)); }
	
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#deleteAll()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#count()
	 */
	@Override
	public long count() {
	...
	/* (non-Javadoc)
	 * @see ua.com.currencyexchange.dao.Dao#exists(java.io.Serializable)
	 */
	@Override
